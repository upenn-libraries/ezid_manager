...
def workbook.populate(dataset)
  ...
  until source_worksheet[y].nil?
    ...
    erc_information[source_worksheet[y][0].value] = { erc_who: source_worksheet[y][1].value.to_s,
                                                      erc_what: source_worksheet[y][2].value.to_s,
                                                      erc_when: source_worksheet[y][3].value.to_s }
    y += 1
  end
